...
Available commands:
    ...
    selfbots are against discord`s ToS but if you are seeing this message then you dont care or you know it allready so use this at you`r own risk blah blah blah...
"""
